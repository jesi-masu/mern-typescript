...
const ManualOrderProcess = () => {
  const steps = [
    {
      ...
      description:
        "Experience our white-glove service with personalized consultation and detailed project assessment by our master craftsmen.",
      icon: Quote,
    ...
    },
    {
      ...
      description:
        "Choose from our curated selection of premium payment solutions, tailored to your financial preferences and requirements.",
      icon: CreditCard,
    ...
    },
    {
      ...
      description:
        "Coordinate with our concierge team to schedule your installation at a time that perfectly aligns with your lifestyle.",
      icon: Calendar,
    ...
    },
    {
      ...
      title: "Installation",
      description:
        "Our certified artisans deliver flawless installation with meticulous attention to detail and uncompromising quality standards.",
      icon: Wrench,
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-white to-slate-100 py-32 px-4 -mt-5 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-8xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
            Elevate your experience with our bespoke manual order process. Our
            dedicated specialists provide personalized attention and expert
            guidance throughout your luxury journey.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {steps.map((step, index) => (
              <div key={step.id} className="relative group">
                {/* Glow effect */}
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${step.gradient} opacity-0 group-hover:opacity-20 blur-xl transition-all duration-700 rounded-2xl`}
                ></div>
                ...
                <div className="relative bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl hover:border-slate-300/80 transition-all duration-700 ease-out transform hover:-translate-y-3 hover:shadow-2xl hover:shadow-slate-500/10 group">
                  ...
                  <div className="relative p-10">
                    ...
                    {/* Premium Icon */}
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${step.gradient} rounded-xl flex items-center justify-center mb-8 mx-auto shadow-lg ${step.shadowColor} group-hover:shadow-xl group-hover:scale-110 transition-all duration-500`}
                    >
                  ...
                  <div className="px-10 pb-8">
                    <div className="h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent overflow-hidden">
                      <div
                        className={`h-full bg-gradient-to-r ${step.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-center`}
                      ></div>
                    </div>
                  </div>
                </div>
