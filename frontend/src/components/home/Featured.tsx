...
const PrefabContainerSection = () => {
  ...
  const applications = [
    {
      ...
      description:
        "Contemporary container homes with full amenities, eco-friendly materials, and customizable layouts for modern families.",
      icon: Home,
      features: [
    ...
    },
    {
      ...
      description:
        "Modern office containers for startups, remote teams, and expanding businesses with professional interiors and full connectivity.",
      icon: Building2,
      features: [
        "Modern interiors",
        "Climate control",
    ...
    },
    {
      ...
      description:
        "Worker accommodations for construction sites and camps with privacy partitions, shared facilities, and durable construction.",
      icon: Users,
      features: [
        "Multiple occupancy",
        "Privacy partitions",
    ...
    },
    {
      ...
      description:
        "Professional retail outlets and showrooms with attractive facades, display areas, and full brand customization options.",
      icon: Store,
      features: [
        "Attractive facades",
        "Display areas",
    ...
    },
    {
      ...
      description:
        "Cost-effective business spaces for entrepreneurs with professional appearance, flexible terms, and growth-ready infrastructure.",
      icon: Briefcase,
      features: [
        "Affordable setup",
        "Professional image",
    ...
    },
    {
      ...
      description:
        "Self-contained facilities for events,   construction sites, and remote locations with easy transport and quick setup capabilities.",
      icon: Wrench,
      features: [
        "Easy transport",
        "Quick setup",
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prev) => (prev - 1 + applications.length) % applications.length
    );
    setIsAutoPlaying(false);
  };
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover versatile, sustainable, and cost-effective solutions for
            your space needs. Our prefabricated containers adapt to any
            requirement with premium quality and modern design.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-6 left-6 z-40">
                  <div
                    className={`w-12 h-12 ${currentApp.bgColor} rounded-xl flex items-center justify-center backdrop-blur-sm`}
                  >
                    <IconComponent
                      className={`w-6 h-6 ${currentApp.iconColor}`}
                    />
                  </div>
                </div>
                ...
                <div className="absolute bottom-16 left-6 right-6 z-40">
                  ...
                  <div
                    className={`w-16 h-1 bg-gradient-to-r ${currentApp.gradient} rounded-full mb-3`}
                  ></div>
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-lg font-semibold bg-gradient-to-r ${currentApp.gradient} bg-clip-text text-transparent`}
                    >
                      {currentApp.subtitle}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {currentApp.features.map((feature, idx) => (
                      ...
                      >
                        <div
                          className={`w-2 h-2 bg-gradient-to-r ${currentApp.gradient} rounded-full flex-shrink-0`}
                        ></div>
                  ...
                  <div className="flex gap-4 pt-4">
                    <button
                      className={`bg-gradient-to-r ${currentApp.gradient} text-white font-semibold py-3 px-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105`}
                    >
                      Learn More
                    </button>
                  ...
                  <div className="aspect-[4/3] relative">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-3">
                      <div className="flex justify-between items-start">
                        <div
                          className={`w-8 h-8 ${app.bgColor} rounded-lg flex items-center justify-center`}
                        >
                          <ThumbnailIcon
                            className={`w-4 h-4 ${app.iconColor}`}
                          />
                        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-xl max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              ...
              Custom designs, professional installation, and ongoing support
              included.
            </p>
