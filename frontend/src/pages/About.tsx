  ...
  const teamMembers = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500&q=80",
    },
    {
      name: "Marcus Johnson",
      ...
      image:
        "https://images.unsplash.com/photo-1500673922987-e212871fec22?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500&q=80",
    },
    {
      name: "Sophia Chen",
      ...
      image:
        "https://images.unsplash.com/photo-1466442929976-97f336a657be?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500&q=80",
    },
    {
      name: "David Patel",
      ...
      image:
        "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=500&q=80",
    },
  ];
  ...
  const values = [
    {
      ...
      icon: "💡",
      description:
        "Pioneering new technologies and design approaches in prefabricated construction to deliver cutting-edge solutions.",
    },
    {
      title: "Sustainability",
      icon: "🌿",
      description:
        "Committed to environmentally responsible practices, from material selection to energy-efficient designs.",
    },
    {
      title: "Excellence",
      icon: "✨",
      description:
        "Rigorous standards in design and manufacturing ensure durable, precision-crafted structures that surpass expectations.",
    },
    {
      title: "Integrity",
      icon: "🤝",
      description:
        "Upholding the highest ethical standards and fostering transparent, trust-based relationships with all stakeholders.",
    },
  ];
  ...
  const partnerLogos = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1542831371-d3493b0b7596?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyMHx8ZW52aXJvbm1lbnRhbCUyMGNvbnN0cnVjdGlvbnxlbnwwfHx8fDE3MTc1NTU0Mjl8MA&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Leading in sustainable building materials and green construction methodologies.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1510511459019-5da70949e217?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw0fHxtYXRlcmlhbHMlMjBzdXBwbHl8ZW53MHx8fHwxNzE3NTU1MzU2fDA&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Premier supplier of high-quality, ethically sourced construction materials worldwide.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1502672260266-fe495817c768?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyfHx1cmJhbiUyMGRldmVsb3BtZW50fGVufDB8fHx8MTcxNzU1NTM5MHww&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Specializing in smart city infrastructure and modern urban development projects.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1460598822558-75177a6dd24b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMHx8ZnV0dXJlJTIwY29uc3RydWN0aW9ufGVufDB8fHx8MTcxNzU1NTQ0MHww&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Innovating structural engineering with a focus on resilience and advanced analytics.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1533535928669-79c29f451f22?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyMHx8cm9ib3RpY3N8ZW53MHx8fHwxNzE3NTU1NDUxfDA&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Leading provider of robotic automation for high-precision manufacturing.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517457375823-ce69a6f1d2e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxNHx8YXJjaGl0ZWN0dXJlJTIwZGVzaWdufGVufDB8fHx8MTcxNzU1NTQ2Mnww&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Renowned for innovative and aesthetic architectural designs in commercial spaces.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1507679799977-c918365812f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyMXx8c21hcnQlMjBncmlkJTIwZW5lcmd5fGVufDB8fHx8MTcxNzU1NTQ4Mnww&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Developing intelligent energy solutions for self-sufficient modular buildings.",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1534790566855-4cb788d389ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxMnx8bGFuZHNjYXBpbmclMjBhcmNoaXRlY3R1cmV8ZW53MHx8fHwxNzE3NTU1NDk0fDA&ixlib=rb-4.0.3&q=80&w=400",
      description:
        "Specialists in integrating sustainable and beautiful landscape architecture.",
    },
  ];
  ...
  const timelineEvents = [
    {
      ...
      description:
        "CamcoPrefab was founded with a clear vision to revolutionize construction through advanced modular building techniques, driven by a commitment to efficiency and sustainability.",
    },
    {
      year: "2019",
      title: "First Modular Prototype & R&D Facility",
      description:
        "Successfully developed and tested our initial modular prototype. Established our dedicated Research & Development facility to continuously innovate designs and materials.",
    },
    {
      year: "2020",
      title: "Proprietary Platform Launch",
      description:
        "Launched our innovative online platform, enabling clients to visualize, customize, and manage their modular projects with unparalleled ease and transparency.",
    },
    {
      year: "2021",
      title: "Expansion into Commercial Projects",
      description:
        "Expanded our portfolio to include large-scale commercial and institutional projects, showcasing the versatility and scalability of our prefabricated solutions.",
    },
    {
      year: "2022",
      title: "Sustainability Certification & Green Initiatives",
      description:
        "Achieved leading industry sustainability certifications. Implemented new green manufacturing processes, significantly reducing waste and energy consumption.",
    },
    {
      year: "2023",
      title: "Global Partnership & International Reach",
      description:
        "Formed strategic international partnerships, extending our reach and delivering modular solutions to clients in new global markets.",
    },
    {
      year: "2024",
      title: "AI-Powered Design Integration",
      description:
        "Integrated AI into our design processes, enhancing efficiency, optimizing material use, and allowing for even more complex and custom architectural solutions.",
    },
    {
      year: "Present",
      title: "Pioneering the Future of Construction",
      description:
        "Continuing to push the boundaries of modular construction, focusing on smart building technologies and resilient, adaptable structures for tomorrow's world.",
    },
  ];
    ...
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <source
              src="https://cdn.pixabay.com/video/2024/03/30/206221_tiny.mp4"
              type="video/mp4"
            />
            {/* Fallback image */}
            <img
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-4xl text-left">
            {" "}
            {/* Changed to max-w-4xl and text-left */}
            {/* Header Section */}
            <div className="mb-12">
              {/* Elegant badge */}
              <div className="inline-flex items-center px-6 py-3 mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white/90 text-sm font-medium shadow-2xl">
                ...
                <span className="ml-3 px-2 py-1 bg-blue-500/30 rounded-full text-xs">
                  Award Winning
                </span>
              </div>

              {/* Main heading with formal typography */}
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-extralight mb-6 leading-tight text-white tracking-tight">
                {" "}
                {/* Adjusted leading */}
                <span className="block font-thin text-white/90">
                  Pioneering
                </span>
                ...
                <span className="block text-5xl md:text-6xl lg:text-7xl font-extralight text-white/95 mt-2">
                  in Modern{" "}
                  <em className="font-bold not-italic text-blue-300">
                    Construction
                  </em>
                </span>
              </h1>
            ...
            <div className="max-w-3xl">
              ...
              {/* Enhanced subtitle */}
              <p className="text-xl md:text-2xl lg:text-2xl text-gray-200 mb-10 leading-relaxed font-light">
                {" "}
                {/* Adjusted font size and margin */}
                Redefining construction through innovative modular solutions
                that seamlessly blend{" "}
                <span className="text-blue-300 font-semibold bg-blue-900/20 px-2 py-1 rounded">
                  quality
                </span>
                ,{" "}
                <span className="text-blue-300 font-semibold bg-blue-900/20 px-2 py-1 rounded">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  Established in 2018, CamcoPrefab emerged from a vision to
                  transform traditional construction through modular excellence.
                  Our founders recognized the untapped potential of
                  prefabrication to deliver superior quality, reduced timelines,
                  and enhanced sustainability.
                </p>
                <p>
                  What began as an innovative concept has grown into an industry
                  leader, serving discerning clients across residential,
                  commercial, and institutional sectors. Our journey reflects
                  our commitment to pushing boundaries while maintaining
                  uncompromising standards.
                </p>
                <p>
                  Today, we stand at the forefront of the prefabrication
                  revolution, with a proprietary platform that seamlessly
                  integrates 3D visualization, customization, and project
                  management—empowering clients to realize their architectural
                  visions with unprecedented clarity and confidence.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-100 to-blue-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900 tracking-tight">
              Our <span className="text-blue-700">Purpose</span> &{" "}
              <span className="text-blue-700">Direction</span>
            </h2>
            <p className="text-xl text-gray-700 leading-relaxed font-light">
              We are driven by a clear set of principles that define who we are
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <Card className="border-t-4 border-blue-600 shadow-xl rounded-xl overflow-hidden transform hover:scale-105 transition-all duration-500 bg-white group">
              <CardContent className="p-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-3xl font-bold mb-4 text-gray-900 group-hover:text-blue-800 transition-colors duration-300">
                  Our Mission
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed">
                  To deliver exceptional prefabricated building solutions that
                  set new benchmarks for quality, efficiency, and environmental
                  responsibility—transforming how structures are conceived and
                  constructed, fostering a more sustainable future.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-t-4 border-purple-600 shadow-xl rounded-xl overflow-hidden transform hover:scale-105 transition-all duration-500 bg-white group">
              <CardContent className="p-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-3xl font-bold mb-4 text-gray-900 group-hover:text-purple-800 transition-colors duration-300">
                  Our Vision
                </h3>
                <p className="text-lg text-gray-700 leading-relaxed">
                  To lead the global evolution toward smarter construction—where
                  modular precision, sustainable practices, and technological
                  innovation converge to create spaces that inspire, endure, and
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-700 leading-relaxed font-light">
              These core values are the bedrock of our culture, shaping every
            ...
            {values.map((value, index) => (
              ...
              >
                <CardContent className="p-8 text-center flex flex-col items-center h-full">
                  <div className="text-5xl mb-5 group-hover:scale-110 transition-transform duration-300 text-blue-500">
                    {value.icon}
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              The experienced professionals guiding CamcoPrefab toward continued
              innovation
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              ...
              collaborative partnerships and meticulous attention to every
              detail
            </p>
          </div>
                    ...
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg">
                          Our team communicates openly, understanding the
                          project's complexity. Creating a solution that
                          supports our client's vision through comprehensive
                  ...
                  <CardContent className="p-10">
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg">
                          A collaborative partnership ensures co-created
                          solutions exceeding expectations. Transparent
                          communication and mutual brainstorming reflect unique
                  ...
                  <CardContent className="p-10">
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg">
                          Timely, secure delivery of prefabricated structures,
                          followed by expert installation. A meticulous approach
                          guarantees structural integrity and customer
                          satisfaction from transportation to setup.
                        </p>
                  ...
                  <CardContent className="p-10">
                    <div className="flex items-start space-x-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg">
                          Following strict guidelines in all aspects, including
                          material selection and final inspection. Products
                          always meet high standards through unwavering
                          dedication to quality and modern testing techniques.
                        </p>
